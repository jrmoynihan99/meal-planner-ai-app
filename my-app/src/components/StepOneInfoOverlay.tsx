...
export default function StepOneInfoOverlay({
  onClose,
  ...
  const title = "Input Your Basic Info";
  const description =
    "This step helps calculate your daily calorie needs based on your biological sex, age, height, weight, and activity level.";
